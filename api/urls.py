...
urlpatterns = [
    ...
    #--------- JUSTIFICATION URLs ---------#
    #path('justification/lista', views.JustificationListView.as_view(), name='get_justification'), 
    path('justification/list', views.JustificationSearchView.as_view(), name='justification_search'),
